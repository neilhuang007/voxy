...
public class WorldImporter implements IDataImporter {
    ...
    private void importSectionNBT(int x, int y, int z, CompoundTag section) {
        ...
        byte[] blockLightData = section.contains("BlockLight", 7) ? section.getByteArray("BlockLight") : EMPTY;
        byte[] skyLightData = section.contains("SkyLight", 7) ? section.getByteArray("SkyLight") : EMPTY;
